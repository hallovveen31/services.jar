...
.field private static final ICON_DUMMY:I = 0x108072d

.field private static final ICON_NETWORKS_AVAILABLE:I = 0x10806d1

.field private static final ICON_NETWORKS_CONNECTED:I = 0x108072b

.field private static final ICON_NETWORKS_DISABLED:I = 0x108072c

.field private static final ICON_NETWORKS_ENABLED:I = 0x108072e
...
.field private static final ICON_NETWORKS_NOT_CONNECTED:I = 0x1080730

.field private static final ICON_NETWORKS_NO_NETWORK:I = 0x108072f
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v9, p0, Lcom/android/server/WifiService;->mScanCount:Ljava/util/HashMap;
    ...
    .line 1863
    new-instance v9, Lcom/android/server/WifiService$8;

    invoke-direct {v9, p0}, Lcom/android/server/WifiService$8;-><init>(Lcom/android/server/WifiService;)V

    iput-object v9, p0, Lcom/android/server/WifiService;->mReceiver:Landroid/content/BroadcastReceiver;

    .line 3469
    new-instance v9, Lcom/android/server/WifiService$9;

    invoke-direct {v9, p0}, Lcom/android/server/WifiService$9;-><init>(Lcom/android/server/WifiService;)V
    ...
    .line 578
    .local v5, idleIntent:Landroid/content/Intent;
    iget-object v9, p0, Lcom/android/server/WifiService;->mContext:Landroid/content/Context;
    ...
    .line 823
    .local v1, IMS_LOWSIGNAL_STATUS:Ljava/lang/String;
    const-string v9, "com.movial.ipphone.IPUtils"
    ...
    .line 825
    .local v0, IMS_LOWSIGNAL:Ljava/lang/String;
    iget-object v9, p0, Lcom/android/server/WifiService;->mContext:Landroid/content/Context;
    ...
    .line 843
    .end local v0           #IMS_LOWSIGNAL:Ljava/lang/String;
    .end local v1           #IMS_LOWSIGNAL_STATUS:Ljava/lang/String;
    :goto_0
    iget-object v9, p0, Lcom/android/server/WifiService;->mContext:Landroid/content/Context;
    ...
    .line 908
    .local v8, wifiThread:Landroid/os/HandlerThread;
    ...
    :try_start_1
    invoke-virtual {v7}, Landroid/os/PowerManager;->getSupportedFrequency()[I
    ...
    const-string v11, "max Frequency : "
    ...
    invoke-virtual {v7, v9, v6, v10}, Landroid/os/PowerManager;->newDVFSLock(IILjava/lang/String;)Landroid/os/PowerManager$DVFSLock;

    move-result-object v9

    iput-object v9, p0, Lcom/android/server/WifiService;->mDVFSLock:Landroid/os/PowerManager$DVFSLock;
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1

    .line 944
    .end local v6           #maxFreq:I
    :cond_1
    :goto_1
    iget-object v9, p0, Lcom/android/server/WifiService;->mContext:Landroid/content/Context;
    ...
    .end local v8           #wifiThread:Landroid/os/HandlerThread;
    :catch_0
    move-exception v3
    ...
    .restart local v8       #wifiThread:Landroid/os/HandlerThread;
    :catch_1
    move-exception v3
...
.method static synthetic access$2402(Lcom/android/server/WifiService;J)J
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2600(Lcom/android/server/WifiService;ZIZI)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$3000(Lcom/android/server/WifiService;)Landroid/app/AlarmManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3400(Lcom/android/server/WifiService;)Ljava/util/HashMap;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$4000(Lcom/android/server/WifiService;)Lcom/android/server/WifiService$LockList;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$4100(Lcom/android/server/WifiService;Landroid/os/IBinder;)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$4900(Lcom/android/server/WifiService;)Ljava/util/List;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$5000(Lcom/android/server/WifiService;II)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method private acquireWifiLockLocked(Lcom/android/server/WifiService$WifiLock;)Z
    ...
    invoke-static {v3, p1}, Lcom/android/server/WifiService$LockList;->access$4600(Lcom/android/server/WifiService$LockList;Lcom/android/server/WifiService$WifiLock;)V
...
.method private releaseWifiLockLocked(Landroid/os/IBinder;)Z
    ...
    invoke-static {v4, p1}, Lcom/android/server/WifiService$LockList;->access$4800(Lcom/android/server/WifiService$LockList;Landroid/os/IBinder;)Lcom/android/server/WifiService$WifiLock;
...
.method private declared-synchronized reportStartWorkSource()V
    ...
    invoke-static {v1}, Lcom/android/server/WifiService$LockList;->access$3600(Lcom/android/server/WifiService$LockList;)Ljava/util/List;
...
.method private updateWifiState()V
    ...
    invoke-static {v5}, Lcom/android/server/WifiService$LockList;->access$3700(Lcom/android/server/WifiService$LockList;)Z
    ...
    invoke-static {v5}, Lcom/android/server/WifiService$LockList;->access$3800(Lcom/android/server/WifiService$LockList;)I
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {v4, p2}, Lcom/android/server/WifiService$LockList;->access$3900(Lcom/android/server/WifiService$LockList;Ljava/io/PrintWriter;)V
...
.method public updateWifiLockWorkSource(Landroid/os/IBinder;Landroid/os/WorkSource;)V
    ...
    invoke-static {v6, p1}, Lcom/android/server/WifiService$LockList;->access$4700(Lcom/android/server/WifiService$LockList;Landroid/os/IBinder;)I
    ...
    #getter for: Lcom/android/server/WifiService$LockList;->mList:Ljava/util/List;
    invoke-static {v6}, Lcom/android/server/WifiService$LockList;->access$3600(Lcom/android/server/WifiService$LockList;)Ljava/util/List;
